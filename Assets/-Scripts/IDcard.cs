...
public class IDcard : MonoBehaviour
{
    ...
    public Sprite IDcardBig;
    public Sprite IDcardSmall;
    ...
    private float TopTableBorder = 2.3f;
    private float BottomTableBorder = -5.8f;
    ...
    void Update()
    {
        ...
        {
            offsetSmall = offset;
            GetComponent<SpriteRenderer>().sprite = IDcardBig;
        ...
        {
            offsetBig = offset;
            GetComponent<SpriteRenderer>().sprite = IDcardSmall;
